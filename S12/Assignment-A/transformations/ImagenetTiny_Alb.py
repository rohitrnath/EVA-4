...
class AlbumentationPILImageDataset(Dataset):
    def __init__(self, image_list, augmentation = None):
...
class Imagenet_Alb:
    ...
    def load_imagenet_data(self,train_set,test_set):
        ...
        self.m_train_loader = torch.utils.data.DataLoader(train_set, batch_size=500,
                                          shuffle=True, num_workers=4)
        self.m_test_loader = torch.utils.data.DataLoader(test_set, batch_size=500,
